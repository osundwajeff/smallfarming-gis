...
COMMENT ON COLUMN vegetation_point.estimated_crown_radius_m is 'Estimated radius of the plants crown in meters.';
...
'Stores pruning activities of individual plant';
...
'Stores harvest activities of individual plant';
...
COMMENT ON COLUMN plant_growth_activities.fk_plant_activity_uuid is 'The foreign key linking to plant growth activity type tables UUID.';
COMMENT ON COLUMN plant_growth_activities.fk_plant_type_uuid is 'The foreign key linking to plant type tables UUID.';
COMMENT ON COLUMN plant_growth_activities.fk_month_uuid is 'The foreign key linking to month tables UUID.';
...
COMMENT ON COLUMN plant_type_usages.fk_plant_usage_uuid is 'The foreign key linking to plant usage tables UUID.';
COMMENT ON COLUMN plant_type_usages.fk_plant_type_uuid is 'The foreign key linking to plant type tables UUID.';
